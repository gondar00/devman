...
function getCredHeaders(): Record<string, string> {
  ...
  const linear = localStorage.getItem("db_linearToken");
  const github = localStorage.getItem("db_githubToken");
  const slack = localStorage.getItem("db_slackToken");
...
export function AgentChat({
  ...
  const credHeaders = useMemo(() => getCredHeaders(), []);
